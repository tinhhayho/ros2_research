...
| 6 | MINOR | "DM = DoIP-only" pinned to AP R22-11; R23-11/R24-11 never re-checked (autosar.org unreachable from sandbox); one unconfirmed web summary suggests R24-11 may add CAN to DM | Currency note added to row 7 of the verdict table; claim text unchanged (the web summary matches the known search-synthesis failure mode — do NOT adopt it without fetching the actual PDF) |
