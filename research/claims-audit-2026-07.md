...
| F8 | Classic has SOME/IP Transformer since AUTOSAR 4.2.1 (2016) — predates AP's first release R17-03 (March 2017; earlier stated R17-10, corrected 2026-07-14); Classic also does Ethernet/DoIP/LIN/FlexRay | https://www.some-ip.com/papers/cache/AUTOSAR_SWS_SOMEIPTransformer_4.2.1.pdf · R17-03-first verified via autosar.org (R17-03 standards set 2017-03-31; R17-10 announcement 2017-10-27 = second release) — see research/fact-check-2026-07-14.md | confirmed | refutes draft's "Classic = CAN only" row |
